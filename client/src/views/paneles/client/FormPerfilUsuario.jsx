...
const FormPerfilUsuario = ({ usuario, onSubmit, onClose }) => {
		...
		<form
			...
			<div className="flex gap-2 pt-2">
				<button
					type="button"
					onClick={onClose}
					className="flex-1 bg-gray-200 text-gray-700 py-2 rounded font-bold hover:bg-gray-300 transition-all">
					Cancelar
				</button>
				<button
					type="submit"
					className="flex-1 bg-vivero-dark text-vivero-gold py-2 rounded font-bold hover:scale-[1.02] transition-all">
					Guardar Cambios
				</button>
			</div>
		</form>
